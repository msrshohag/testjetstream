          ...
          <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav class="px-2 mt-5 space-y-1">
              ...
              <a href="#" class="flex items-center px-2 py-2 text-base font-medium text-white bg-indigo-800 rounded-md group">
                ...
                <svg class="flex-shrink-0 w-6 h-6 mr-4 text-indigo-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
            ...
            <a href="#" class="flex-shrink-0 block group">
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  ...
                  <p class="text-sm font-medium text-indigo-200 group-hover:text-white">{{ Auth::user()->email }}</p>
                </div>
              </div>
            </a>
          </div>
      ...
      <div class="flex flex-col flex-1 min-h-0 bg-indigo-700">
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
          ...
          <nav class="flex-1 px-2 mt-5 space-y-1">
            <!-- Current: "bg-indigo-800 text-white", Default: "text-white hover:bg-indigo-600 hover:bg-opacity-75" -->
            <a href="#" class="flex items-center px-2 py-2 text-sm font-medium text-white bg-indigo-800 rounded-md group">
              <!-- Heroicon name: outline/home -->
              <svg class="flex-shrink-0 w-6 h-6 mr-3 text-indigo-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              Dashboard
            </a>
  
            <a href="#" class="flex items-center px-2 py-2 text-sm font-medium text-white rounded-md hover:bg-indigo-600 hover:bg-opacity-75 group">
              <!-- Heroicon name: outline/users -->
              <svg class="flex-shrink-0 w-6 h-6 mr-3 text-indigo-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
          ...
          <a href="#" class="flex-shrink-0 block w-full group">
            <div class="flex items-center">
              ...
              <div class="ml-3">
                ...
                <p class="text-xs font-medium text-indigo-200 group-hover:text-white">{{ Auth::user()->email }}</p>
              </div>
            </div>
          </a>
        </div>
