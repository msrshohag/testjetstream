<footer class="bg-white">
        ...
        <div class="flex flex-col w-full py-6 md:flex-row">
            ...
            <div class="flex-1">
                ...
                <ul class="mb-6 list-reset">
                    ...
                    <li class="inline-block mt-2 mr-2 md:block md:mr-0">
                        <a href="#"
                            class="text-gray-800 no-underline hover:underline hover:text-pink-500">Help</a>
                    </li>
                    <li class="inline-block mt-2 mr-2 md:block md:mr-0">
                        <a href="#"
            ...
            <div class="flex-1">
                ...
                <ul class="mb-6 list-reset">
                    <li class="inline-block mt-2 mr-2 md:block md:mr-0">
                        <a href="#"
                            class="text-gray-800 no-underline hover:underline hover:text-pink-500">Official Blog</a>
                    </li>
                    <li class="inline-block mt-2 mr-2 md:block md:mr-0">
    ...
    <a href="#" class="text-center text-gray-500">Developed by - AHZ Associates</a>
</footer>
